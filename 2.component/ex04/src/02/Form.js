...
export default function Form() {
    ...
    const onChangeEmailInput = e => {
        ...
        setValidEmail(regEmail.test(e.target.value))
    }
        ...
        <form id="joinForm" name="joinForm" method="post" action="/do/not/post">
            ...
            <input 
                ...
                { email === '' ?
                    null :
                    validEmail ? 
                    <FontAwesomeIcon icon={faCheckCircle} style={{fontSize: 16, color: 'blue', marginLeft: 5}} /> : 
                    <FontAwesomeIcon icon={faTimesCircle} style={{fontSize: 16, color: 'red', marginLeft: 5}} /> 
                }
